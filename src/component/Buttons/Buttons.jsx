...
const Buttons = ({ handleAvailableBtn, activeBtn, availablePlayers, handleChoosePlayer, choosePlayer,handleRemovePlayer }) => {
    ...
    return (
        <div>
            ...
            {
                activeBtn.status ? <AvailablePlayers availablePlayers={availablePlayers} handleChoosePlayer={handleChoosePlayer}></AvailablePlayers> : <SelectedPlayers choosePlayer = {choosePlayer} handleRemovePlayer = {handleRemovePlayer}></SelectedPlayers>
            }
        </div>
    );
};
